...
export function AttributeIcon(props: IconProps) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
export function PredicateIcon(props: IconProps) {
  return (
    <svg
      fill="none"
      viewBox="0 0 24 24"
...
export function LoadingSpinner({
  ...
  return (
    <div
      className={`animate-spin border border-gray-300 border-t-gray-500 rounded-full ${className}`}
    />
  );
}
